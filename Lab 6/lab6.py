...
while not adequate:
    ...
    while not homogeneous:
        ...
        if Gt > Gp:
            ...
            print("Дисперсія неоднорідна при рівні значимості {:.2f}! Збільшуємо m.".format(q))
            m += 1
    ...
    if d == 3:
        print("\nКількість значимих коефіцієнтів - 3. Рівняння регресії не адекватне оригіналу. Вихід із програми.")
        quit()
    else:
        if fisher_test():
            ...
            print("\nРівняння регресії не адекватне оригіналу\n\t Проводимо експеримент повторно")